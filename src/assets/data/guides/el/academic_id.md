...
Μπορείτε να ζητήσετε ακαδημαϊκή ταυτότητα στην [ιστοσελίδα του Υπουργείου Παιδείας](https://academicid.minedu.gov.gr/).
...
Στην είσοδο, επιλέξτε **"Προπτυχιακός Φοιτητής"** και χρησιμοποιήστε το username του ακαδημαϊκού email και τον κωδικό που σας έδωσαν.
...
Επίσης μπορείτε να αλλάξετε το τηλέφωνό σας σε φοιτητικό.

Σε κάθε εξάμηνο πρέπει να δηλώνετε τα μαθήματα στην υπηρεσία [UniPortal](https://uniportal.ihu.gr/). Στο πρώτο εξάμηνο σπουδών, τα μαθήματα δηλώνονται αυτόματα για τους φοιτητές από τη γραμματεία.
